...
public class ThrowEventJsonConverter extends BaseBpmnJsonConverter {
  ...
  public static void fillJsonTypes(Map<String, Class<? extends BaseBpmnJsonConverter>> convertersToBpmnMap) {
    ...
    convertersToBpmnMap.put(STENCIL_EVENT_THROW_COMPENSATE, ThrowEventJsonConverter.class); 
  }
  ...
  protected String getStencilId(BaseElement baseElement) {
    ...
    if (eventDefinition instanceof SignalEventDefinition) {
      return STENCIL_EVENT_THROW_SIGNAL;
        ...
        return STENCIL_EVENT_THROW_COMPENSATE;
      }else {
      return STENCIL_EVENT_THROW_NONE;
    }
  }
  ...
  protected FlowElement convertJsonToElement(JsonNode elementNode, JsonNode modelNode, Map<String, JsonNode> shapeMap) {
    ...
    }else if (STENCIL_EVENT_THROW_COMPENSATE.equals(stencilId)) {
        convertJsonToCompensateDefinition(elementNode, throwEvent);
      }
    return throwEvent;
  }
}
