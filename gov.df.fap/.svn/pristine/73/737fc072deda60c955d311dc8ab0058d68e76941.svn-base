...
//stencil items
  ...
  final String STENCIL_TASK_USER = "ExtUserTask";
  ...
  final String STENCIL_EVENT_THROW_COMPENSATE = "ThrowCompensationEvent";

  final String STENCIL_SEQUENCE_FLOW = "SequenceFlow";
  //增加跨节点
  final String STENCIL_SEQUENCE_JUMP_FLOW = "SequenceJumpFlow";
  ...
  final String STENCIL_DATAOBJECT = "DataObject";

  final String PROPERTY_VALUE_YES = "Yes";
  final String PROPERTY_VALUE_TRUE = "true";
  ...
  final String PROPERTY_TIMER_DATE_PARAM= "timerdateparamdefinition";
  ...
  final String PROPERTY_COMPENSATE_ACTIVITYREF = "activityref";
  final String PROPERTY_COMPENSATE_WAITFORCOMPLETION = "waitforcompletion";
  final String PROPERTY_COMPEMSATE = "forcompensation";
  ...
  final String PROPERTY_USERTASK_PRIORITY = "multiinstance_priority";
  final String PROPERTY_USERTASK_DUEDATE = "duedatedefinition";
  final String PROPERTY_USERTASK_PARAM_DUEDATE = "duedateparamdefinition";
  ...
  final String PROPERTY_USERTASK_ASSIGNABLE = "assignable";
  ...
  //增加跨节点
  final String PROPERTY_SEQUENCEJUMPFLOW_CONDITION = "conditionsequencejumpflow";
