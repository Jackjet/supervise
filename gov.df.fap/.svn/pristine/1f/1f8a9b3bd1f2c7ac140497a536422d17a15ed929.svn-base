...
public class SysRightGroupDetail implements Serializable {
  ...
  /** full constructor */
  public SysRightGroupDetail(String RIGHT_GROUP_ID, String ELE_CODE, String ELE_VALUE, Integer SET_YEAR, String ELE_NAME) {
  ...
  public String toString() {
    return new ToStringBuilder(this).append("RIGHT_GROUP_ID", getRIGHT_GROUP_ID()).append("ELE_CODE", getELE_CODE())
      .append("ELE_VALUE", getELE_VALUE()).append("SET_YEAR", getSET_YEAR()).append("ELE_NAME", getELE_NAME())
      .toString();
  }
