...
public class RoleCommonService implements IRoleDfCommonService {
  ...
  public List getMenus(String roleguid) {
    ...
    if ("df".equals(starttype)) {
      ...
      sql
        .append("select t.menu_id guid, t.menu_code code, t.menu_name name, t.level_num levelno, t.is_leaf isleaf, t.parent_id parentid,t.url ,t.disp_order menuorder ,t.icon，t.screentype");
      sql
