...
public class EleBookSet implements Serializable {
  ...
  /** full constructor */
  public EleBookSet(String CHR_ID, int SET_YEAR, String CHR_CODE, String DISP_CODE, String CHR_NAME, int LEVEL_NUM,
    int IS_LEAF, int ENABLED, String CREATE_DATE, String CREATE_USER, String LATEST_OP_DATE, BigDecimal IS_DELETED,
    String LATEST_OP_USER, String LAST_VER, String CHR_CODE1, String CHR_CODE2, String CHR_CODE3, String CHR_CODE4,
    String CHR_CODE5, String RG_CODE, String START_DATE, int SET_TYPE, String PARENT_ID, String CHR_ID1,
  ...
  /** minimal constructor */
  public EleBookSet(String CHR_ID, int SET_YEAR, String DISP_CODE, String CHR_NAME, int LEVEL_NUM, int IS_LEAF,
    int ENABLED, String LATEST_OP_DATE, BigDecimal IS_DELETED, String RG_CODE, String START_DATE, int SET_TYPE) {
    this.CHR_ID = CHR_ID;
    this.SET_YEAR = SET_YEAR;
    this.DISP_CODE = DISP_CODE;
    this.CHR_NAME = CHR_NAME;
