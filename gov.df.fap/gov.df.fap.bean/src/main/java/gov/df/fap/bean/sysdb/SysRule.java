...
public class SysRule implements Serializable {
  ...
  /** full constructor */
  public SysRule(String RULE_ID, String RULE_CODE, String RULE_NAME, String REMARK, int SET_YEAR, Integer ENABLED,
    String RULE_CLASSIFY, String SYS_REMARK, Integer RIGHT_TYPE, String CREATE_USER, String CREATE_DATE,
    String LATEST_OP_USER, String LATEST_OP_DATE) {
  ...
  public String toString() {
    return new ToStringBuilder(this).append("RULE_ID", getRULE_ID()).toString();
  }
