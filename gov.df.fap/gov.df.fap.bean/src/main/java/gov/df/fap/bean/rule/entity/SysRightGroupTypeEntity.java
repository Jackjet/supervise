...
public class SysRightGroupTypeEntity implements Serializable {
  /**
   * 
   */
  ...
  /** full constructor */
  public SysRightGroupTypeEntity(String right_group_id, String ele_code, int right_type, String set_year) {
  ...
  /** default constructor */
  public SysRightGroupTypeEntity() {
  }

  /** minimal constructor */
  public SysRightGroupTypeEntity(String right_group_id, String ele_code) {
    this.right_group_id = right_group_id;
    this.ele_code = ele_code;
  }
  ...
  public String toString() {
    return new ToStringBuilder(this).append("right_group_id", getRight_group_id()).append("ele_code", getEle_code())
      .toString();
  }
