...
public class SysWfNode implements Serializable {
  ...
  */
  ...
  /** full constructor */
  public SysWfNode(String NODE_ID, String WF_ID, String NODE_CODE, String NODE_NAME, String NODE_TYPE,
    String REMARK, String CREATE_USER, String CREATE_DATE, String LATEST_OP_USER, String LATEST_OP_DATE,
    String WF_TABLE_NAME, int GATHER_FLAG, String ID_COLUMN_NAME, String OUTER_TABLE_NAME,
    String OUTER_COLUMN_NAME, String RELATION_COLUMN_NAME, String LAST_VER, String RG_CODE, int SET_YEAR) {
  ...
  /** minimal constructor */
  public SysWfNode(String NODE_ID, String WF_ID, int GATHER_FLAG, int TOLLY_FLAG, String RG_CODE,
 ...
 /* public String toString() {
    return new ToStringBuilder(this).append("NODE_ID", getNODE_ID()).toString();
  }
*/
  ...
  /**
   * @param send_msg_time_unit The sEND_MSG_TIME_UNIT to set.
   */
  ...
  /**
   * @param auto_audit_time_unit The aUTO_AUDIT_TIME_UNIT to set.
   */
