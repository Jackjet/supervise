...
public class RuleEntity implements Serializable {
	...
	public List<RightGroupEntity> right_group_list = new ArrayList<RightGroupEntity> ();
 

	/** full constructor */
    public RuleEntity(String rule_id, String rule_code, String rule_name, String remark, String set_year, int enabled, String rule_classify, String sys_remark, int right_type, String create_user, String create_date, String latest_op_user, String latest_op_date) {
    ...
    /** minimal constructor */
    public RuleEntity(String rule_id, String rule_code, String set_year) {
        this.rule_id = rule_id;
        this.rule_code = rule_code;
        this.set_year = set_year;
    }
	...
	public List<RightGroupEntity> getRight_group_list() {
		return right_group_list;
	}

	public void setRight_group_list(List<RightGroupEntity> right_group_list) {
		this.right_group_list = right_group_list;
	}
