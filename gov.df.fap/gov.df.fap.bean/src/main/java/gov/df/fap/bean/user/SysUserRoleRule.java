...
public class SysUserRoleRule implements Serializable {
  ...
  */
  ...
  /** full constructor */
  public SysUserRoleRule(String ROLE_ID, String RULE_ID, String USER_ID, int SET_YEAR, String LAST_VER, int IS_DEFINED) {
  ...
  public String toString() {
    return new ToStringBuilder(this).append("ROLE_ID", getROLE_ID()).append("USER_ID", getUSER_ID()).toString();
  }
