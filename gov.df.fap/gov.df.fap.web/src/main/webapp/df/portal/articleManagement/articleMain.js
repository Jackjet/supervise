 ...
 */	
	...
	viewModel.getPageData = function (pageNumber) {
        ...
        viewModel.addArticle = function(){
    		window.open("/df/portal/ArticleEdition/articleEdition.html?tokenid="+tokenid,'newwindow',"height=800,width=800,top=20,left=250,scrollbars=yes,toolbar=no,menubar=no,location=no,status=no");
 //   		window.open("/df/portal/ArticleEdition/index.html?tokenid="+tokenid,'newwindow',"height=800,width=800,top=20,left=250,scrollbars=yes,toolbar=no,menubar=no,location=no,status=no");
        ...
        viewModel.editArticle = function(){
        	window.open("/df/portal/ArticleEdition/articleEdition.html?tokenid="+tokenid+"&articleId="+articleid,'newwindow',"height=800,width=800,top=20,left=250,scrollbars=yes,toolbar=no,menubar=no,location=no,status=no");
        };
