...
<table width="1000" border=0 align="center" cellpadding="0"
	...
	<tr>
		...
		<table width="100%" border=0 align="center" cellpadding="0"
			cellspacing="0">
			<tr>
				<td bgcolor="#FFFFFF"><img src="image/top_bg.jpg" width="1000" height="150"></td>
			</tr>
			<tr>
				...
				<table width="100%" border=0 cellpadding="0" cellspacing="0"
					bgcolor="#ffffff" class="font1" style="font-size:12px;">
					<tr>
						...
						<td align="right" width="380">
							<table width="100%" border="0" cellspacing="3" cellpadding="2" class="font1" style="font-size:12px;">
								<tr>
									<td align="right">
								            【<a href="#" onClick="javascript:changeFont('sub');">减小字体</a>】&nbsp;
									【<a href="#" onClick="javascript:changeFont('add');">增大字体</a>】&nbsp;
									【<a href="#" onClick="javascript:printContent();">打印本页</a>】&nbsp;
			...
			<tr>
				...
				<div id="articleDiv" style="width:1000;margin-top:240px">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="150"></td>
					...
					<div id="attachDiv" style="display:none;margin-top:10px">
