require.config({
	...
	paths: {
		...
		md5: "trd/md5/js/md5",
		select2: "trd/select2/select2.full.min",
		ip:"trd/ip/js/ip",
		...
		//csof
		csof:"supervise/common/common",
		jqxsplitter:"trd/splitter/jqxsplitter",
		jqxcore:"trd/splitter/jqxcore",
		csscsof:"supervise/common/cssCommon",
	},
	shim: {
		'ip':{
			deps: ["jqUi"]
		...
		'select2': {
			deps: ["css!trd/select2/select2.min.css"]
		},
		'dateZH': {
			deps: ["bootstrap"]
		},
		...
		'csscsof':{
			deps: ["jquery",
			       "jqUi",
			       'css!trd/splitter/jqx.base.css',
			       'css!supervise/common/common.css'
			       ]
		},
	}
});
