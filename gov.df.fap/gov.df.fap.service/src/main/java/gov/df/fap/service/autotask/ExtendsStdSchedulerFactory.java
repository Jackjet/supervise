...
/**
 * <p>DESCRIPTION: 重新 org.quartz.impl.StdSchedulerFactory 注册我们自己的 jobRunShellFactory
 * <p>DESCRIPTION: 和原 StdSchedulerFactory 
 * <p>CALLED BY:
 ...
 * @see
 */
public class ExtendsStdSchedulerFactory implements SchedulerFactory {
   ...
   */
  public ExtendsStdSchedulerFactory() {
  }
   ...
   */
  public ExtendsStdSchedulerFactory(Properties props) throws SchedulerException {
    initialize(props);
  }
   ...
   */
  public ExtendsStdSchedulerFactory(String fileName) throws SchedulerException {
    initialize(fileName);
  }
  ...
  public void initialize() throws SchedulerException {
    ...
    try {
      if (propFile.exists()) {
        ...
        if (in == null) {
          in = getClass().getClassLoader().getResourceAsStream("org/quartz/quartz.properties");
        }
        if (in == null) {
  ...
  private Scheduler instantiate() throws SchedulerException {
    ...
    for (int i = 0; i < triggerListenerNames.length; i++) {
      ...
      if (listenerClass == null) {
        initException = new SchedulerException("TriggerListener class not specified for listener '"
          + triggerListenerNames[i] + "'", SchedulerException.ERR_BAD_CONFIGURATION);
        throw initException;
      }
    ...
    if (wrapJobInTx) {
      ...
      // jrsf = new StdJobRunShellFactory(); 原实现
      //2015.02.02 使用新的JobRunShell 增加区划 年度
      jrsf = new ExtendsStdJobRunShellFactory();
    }
  ...
  public static Scheduler getDefaultScheduler() throws SchedulerException {
    ExtendsStdSchedulerFactory fact = new ExtendsStdSchedulerFactory();
