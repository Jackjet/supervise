...
public class ContinueFTP2 implements Runnable {
   ...
   * @throws IOException
   */
  public Map<String, Object> download(String remote, String local) throws IOException {
   ...
   * @throws IOException
   */
  public Map<String, Object> upload(MultipartFile local, String remote) throws IOException {
    // 设置PassiveMode传输
    ftpClient.enterLocalPassiveMode();
    // 设置以二进制流的方式传输
    ftpClient.setFileType(FTP.BINARY_FILE_TYPE);
   ...
   * @throws IOException
   */
  public Map uploadFile(String remoteFile, MultipartFile localFile, FTPClient ftpClient, long remoteSize)
    throws IOException {
    UploadStatus status;
    Map<String, Object> map = new HashMap<String, Object>();
    // 显示进度的上传
