...
public class csofTaskUserEntity implements Serializable {
  ...
  private String sup_dep_id;

  private String sup_dep_code;

  private String sup_dep_name;
  ...
  private String sup_start_date;

  private String sup_end_date;
  ...
  public int getSup_cost() {
    return sup_cost;
  }

  public void setSup_cost(int sup_cost) {
  ...
  public String getSup_dep_code() {
    return sup_dep_code;
  }

  public void setSup_dep_code(String sup_dep_code) {
    this.sup_dep_code = sup_dep_code;
  }

  public String getSup_dep_name() {
    return sup_dep_name;
  }

  public void setSup_dep_name(String sup_dep_name) {
    this.sup_dep_name = sup_dep_name;
  }
  ...
  public String getSup_start_date() {
    return sup_start_date;
  }

  public void setSup_start_date(String sup_start_date) {
    this.sup_start_date = sup_start_date;
  }
