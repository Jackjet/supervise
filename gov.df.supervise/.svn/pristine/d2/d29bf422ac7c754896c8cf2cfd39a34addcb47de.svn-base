...
public class csofAccSupDepEntity implements Serializable {
  /**
   * 
   */
  ...
  private String acc_sup_office_id;

  public String getAcc_sup_office_id() {
    return acc_sup_office_id;
  }

  public void setAcc_sup_office_id(String acc_sup_office_id) {
    this.acc_sup_office_id = acc_sup_office_id;
  }
