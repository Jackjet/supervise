...
public class csofAccSupEndEntity implements Serializable {
  /**
   * 
   */
  ...
  public String getAcc_sup_dep_id() {
    return acc_sup_dep_id;
  }

  public void setAcc_sup_dep_id(String acc_sup_dep_id) {
    this.acc_sup_dep_id = acc_sup_dep_id;
  }
